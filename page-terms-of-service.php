...
$banner_title    = t('pages.terms_of_service.hero.title');
$banner_bg_text  = t('pages.terms_of_service.hero.bg_text');
$banner_subtitle = t('pages.terms_of_service.hero.subtitle');
...
<section class="max-w-4xl mx-auto px-4 py-20 font-sans text-slate-900 leading-relaxed space-y-12">
    <div class="prose prose-slate max-w-none">
        <h2 class="text-3xl font-serif font-bold text-slate-900 mb-6"><?php echo esc_html( t('pages.terms_of_service.content.title') ); ?></h2>
        <p class="text-lg text-slate-600 mb-10 pb-10 border-b border-gray-100">
            <?php echo esc_html( t('pages.terms_of_service.content.description') ); ?>
        </p>
        
        <?php
        $sections = t('pages.terms_of_service.content.sections');
